...
<div  id="wrap">
<h2 style="padding:40px;"><font size="9" color="gray">회 원 정 보 변 경</font></h2>	
	<!-- post 방식의 form 구문을 사용하여 submit 버튼을 클릭하면 action 속성에 지정된 웹 서버에 연결하도록 하였습니다.-->
		<form method="post" action="updateTestPro_1.jsp">
      ...
      <tr>  
       ...
       <tr>  
		  <td>부서</td>
        <td> 
		  <input type="text" name="position"placeholder="부서를 입력해주세요" required > </td>
