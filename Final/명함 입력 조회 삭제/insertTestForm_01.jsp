  ...
  <!-- 표만들기 테두리를 0으로 지정 cellpadding은 표의 여백을 2로 지정 -->
    <table border="0" cellspacing="0" cellpadding="2"  align="center">
      ...
      <tr>  
        <td >회사명</td>
        <td> 
		  <input type="text" name="department"  placeholder="회사명을 입력해주세요"> </td>
		  <!-- type속성의 기본 값으로 한줄로 된 텍스트 필드를 정의함. name속성에 name 지정(jsp파일에 연동)
		  placeholder속성으로 필드에 입력할 텍스트의 힌트를 입력 할 수 있음-->
		  <td>직책</td>
        <td> 
      ...
      <tr>  
         <td>전화번호</td>
         <td colspan="3"> 
		   <input type="text" name="tell" placeholder="010-1234-1234"> </td>
     ...
     <tr> 
         ...
         <!-- type속성의 submit 제출버튼을 입력. class 선택자를 sub로 지정하여 스타일 지정. -->
          <input type="submit" value="명 함 입 력" class="sub" > 
              &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 
         <!-- type속성의 reset 리셋버튼을 입력. 작성된 폼을 리셋함. class 선택자를 sub로 지정하여 스타일 지정. -->
           <input type="reset" value="명 함 수 정" class="sub">
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
